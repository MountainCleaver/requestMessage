...
func show_tip(player_mateo: String) -> void:
	tip_interact.visible = true
	can_interact = true
	current_npc = player_mateo


func hide_tip(player_mateo: String) -> void:
	tip_interact.visible = false
	can_interact = false
	current_npc = ""
	
func _input(event):
	if event.is_action_pressed("interact") and $door_area/tip_interact.visible:
...
func _on_ground_tree_entered() -> void:
	pass # Replace with function body.


func _on_ground_tree_exited() -> void:
	pass # Replace with function body.
