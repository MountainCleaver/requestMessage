...
@onready var option_audio: Button = $VBoxContainer/option_audio
@onready var option_display: Button = $VBoxContainer/option_display
@onready var option_controls: Button = $VBoxContainer/option_language

@onready var back: Button = $back_tips/back
