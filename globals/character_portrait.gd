...
var portraits = {
	...
	"Aling Theresa": preload("res://assets/character_sprites/portrait_aling_theresa.png"),
	"Mang Gino": preload("res://assets/character_sprites/portrait_mang gino.png"),
	"Manang Matet": preload("res://assets/character_sprites/portrait_manang matet.png"),
	...
	"Vanesa": preload("res://assets/character_sprites/portrait_vanesa.png"),
	...
	"Conductor": preload("res://assets/character_sprites/portrait_conductor.png"),
	"Pharmacist": preload("res://assets/character_sprites/portrait_pharmacist.png")
}
